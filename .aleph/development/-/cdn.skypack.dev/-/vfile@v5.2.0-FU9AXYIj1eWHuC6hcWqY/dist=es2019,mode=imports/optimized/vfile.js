// https://cdn.skypack.dev/-/vfile@v5.2.0-FU9AXYIj1eWHuC6hcWqY/dist=es2019,mode=imports/optimized/vfile.js
import buffer from "../../../is-buffer@v2.0.5-pEqX5mY5KE8OTGseAfDW/dist=es2019,mode=imports/optimized/is-buffer.js";
import { VFileMessage } from "../../../vfile-message@v3.1.0-PHnuwdS1FqSPsA1KIr99/dist=es2019,mode=imports/optimized/vfile-message.js";
...
function assertPath$1(path2, name) {
  if (!path2) {
    throw new Error("Setting `" + name + "` requires `path` to be set too");
  }
}
var vfile_default = null;
export {
  VFile,
  vfile_default as default
};
