// https://cdn.esm.sh/v53/react@17.0.2/deno/react.js
import __object_assign$ from "../../object-assign@4.1.1/deno/object-assign.js";
var W = Object.create;
...
var Q = (e) => h(e, "__esModule", { value: true });
...
var O = (e) => Z(Q(h(e != null ? W(J(e)) : {}, "default", e && e.__esModule && "default" in e ? { get: () => e.default, enumerable: true } : { value: e, enumerable: true })), e);
var z = j((n) => {
  "use strict";
  ...
  var R = { current: null }, N = Object.prototype.hasOwnProperty, U = { key: true, ref: true, __self: true, __source: true };
  function T(e, t, r) {
  ...
  function v(e, t, r, o, u) {
    ...
    if (f)
      return f = e, u = u(f), e = o === "" ? "." + $(f, 0) : o, Array.isArray(u) ? (r = "", e != null && (r = e.replace(V, "$&/") + "/"), v(u, t, r, "", function(p) {
        return p;
  ...
  var ne = { ReactCurrentDispatcher: B, ReactCurrentBatchConfig: { transition: 0 }, ReactCurrentOwner: R, IsSomeRendererActing: { current: false }, assign: E };
  ...
  n.createContext = function(e, t) {
    return t === void 0 && (t = null), e = { $$typeof: I, _calculateChangedBits: t, _currentValue: e, _currentValue2: e, _threadCount: 0, Provider: null, Consumer: null }, e.Provider = { $$typeof: x, _context: e }, e.Consumer = e;
  };
  n.createElement = T;
